        ...
        <>
                    ...
                    <div className="col-span-2 w-3/4">
                        ...
                        <div className="flex gap-2 mt-1 flex-wrap">
                            {socialLogo.map((a, index) => (
                                <a key={a.id} title={a.title} target="_blank" className="text-white/50 transition-all duration-200 cursor-pointer select-none bg-_secondary w-7 h-7 flex justify-center items-center rounded-md hover:bg-_gray-500 active:bg-_gray-400 hover:text-white active:text-white" href={a.target}>
            ...
            <div className="container">
                <div className="flex flex-col items-center justify-center lg:flex-row lg:items-center lg:justify-between w-full text-white py-12">
                    <p className="text-center lg:text-left text-sm">© 2022 — {(new Date().getFullYear())} Omega Studios. All Right Reserved</p>
                </div>
            </div>
        </>
    )
