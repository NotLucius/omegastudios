                    ...
                    <div className="container flex flex-col justify-center items-center gap-2">
                        <div className="flex w-full justify-between items-center">
                            ...
                            <div className="flex flex-row items-center gap-4">
                                ...
                                <button onClick={() => router.push("/login")} className="hidden lg:flex md:flex xl:flex px-8 py-3 border border-zinc-500/20 hover:border-zinc-500/50 text-zinc-500 hover:text-white items-center font-medium rounded-full transition-all duration-all">
                                    <p>Dashboard </p>
                                </button>
                            </div>
                        </div>
