            ...
            <form ref={form} onSubmit={sendEmail}>
                <div className="container space-y-12 py-24">
                    ...
                    <div className="flex justify-end">
                        <button type="submit" className="w-full lg:w-1/5 justify-center flex items-center gap-2 border border-gray-500/20 hover:border-gray-500/50 text-zinc-500 hover:text-white px-8 py-3 rounded-lg transition-all duration-200">
                            <p>Submit <i className="fas fa-paper-plane ml-2"></i></p>
                        </button>
                    </div>
                </div>
            </form>
