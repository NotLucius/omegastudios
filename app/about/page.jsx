            ...
            <div className="container w-full mt-12">
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 w-full mt-5 justify-start items-center">
                        {team.map((m) => (
                            <div className="w-full flex items-center justify-center border border-zinc-500/20 hover:border-zinc-500/50 p-6 rounded-lg gap-6 transition-all duration-200">
